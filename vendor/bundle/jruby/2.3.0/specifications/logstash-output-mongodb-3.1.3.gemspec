# -*- encoding: utf-8 -*-
# stub: logstash-output-mongodb 3.1.3 ruby lib

Gem::Specification.new do |s|
  s.name = "logstash-output-mongodb".freeze
  s.version = "3.1.3"
  ...
  s.summary = "Writes events to MongoDB".freeze
